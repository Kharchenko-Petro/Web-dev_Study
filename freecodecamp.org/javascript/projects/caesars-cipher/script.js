...
// rot13("GUR DHVPX OEBJA SBK WHZCF BIRE GUR YNML QBT.") should decode 
// to the string THE QUICK BROWN FOX JUMPS OVER THE LAZY DOG.

function rot13(str) {
  const key = 'ABCDEFGHIJKLMNOPQRSTUVWXYZABCDEFGHIJKLM';
  
  return str.replaceAll( /[A-Z]/g, match => key[key.indexOf(match) + 13] );
}
